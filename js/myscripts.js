...
function deleteStock(x){
	bootbox.confirm("WARNING: This will delete this entire stock, not only this product. If you want to delete a product only, you can go to the <a href='products.php'>PRODUCTS</a> page.<br><br>Are you sure you want to delete this stock?", function(result) {
		if(result){
